				  ...
				  unsigned int flags)
{
	...
	printk(KERN_INFO "\033[38;5;200mVFAT_DIR_OPERATIONS - Executing now - vfat_lookup\033[0m\n\n");
		       ...
		       bool excl)
{
	...
	// Add code here to show function name 
	printk(KERN_INFO "\033[38;5;200mVFAT_DIR_OPERATIONS - Executing now - vfat_create\033[0m\n\n");
...
static int vfat_rmdir(struct inode *dir, struct dentry *dentry)
{
	...
	// Add code here to show function name 
	printk(KERN_INFO "\033[38;5;200mVFAT_DIR_OPERATIONS - Executing now - vfat_rmdir\033[0m\n\n");
...
static int vfat_unlink(struct inode *dir, struct dentry *dentry)
{
	...
	// Add code here to show function name 
	printk(KERN_INFO "\033[38;5;200mVFAT_DIR_OPERATIONS - Executing now - vfat_unlink\033[0m\n\n");
...
static int vfat_mkdir(struct inode *dir, struct dentry *dentry, umode_t mode)
{
	...
	// Add code here to show function name 
	printk(KERN_INFO "\033[38;5;200mVFAT_DIR_OPERATIONS - Executing now - vfat_mkdir\033[0m\n\n");
		       ...
		       unsigned int flags)
{
	...
	// Add code here to show function name 
	printk(KERN_INFO "\033[38;5;200mVFAT_DIR_OPERATIONS - Executing now - vfat_rename\033[0m\n\n");
